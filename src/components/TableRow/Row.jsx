...
import { WithdrawNetworks, DepositNetworks } from './CellNetwork'
...
const ArbitrationRow = ({ coin, pairs, open_spread, lifetime_seconds }) => (
	<>
		<div role='cell' className={styles['cell']}>
			<span className={styles['cell-name']}>
		...
		<div role='cell' className={styles['cell']}>
			<CellList
				items={pairs}
				renderItem={({ exchange, price, pair }, i) => (
					<li
						key={i}
						className={styles['cell-item']}>
						<a
		...
		<div role='cell' className={styles['cell']}>
			<CellLifetime lifetime={lifetime_seconds} />
		</div>

		<div role='cell' className={styles['cell']}>
			<WithdrawNetworks items={pairs} />
		</div>

		<div role='cell' className={styles['cell']}>
			<DepositNetworks items={pairs} />
		</div>
	</>
)

const Row = ({ type = 'default', ...rest }) => {
	switch (type) {
    case 'arbitration':
      return <ArbitrationRow {...rest} />
